...
app.route('/edit/:db/:id/sections/:sectionId', require('./views/edit'))
app.route('/edit/:db/:id/sections/:sectionId/resources/:resourceId', require('./views/edit'))
app.route('/edit/:db/:id/resources/:resourceId', require('./views/edit'))
