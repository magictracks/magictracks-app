...
module.exports = function(id, state, emit) {
    ...
    <section class="bw2 flex flex-column ba w-100 mt2 h-auto flex-1 justify-between">
      ...
      <div class="w-100 pa2 overflow-y-scroll mb2 ma0 f7">
        <!-- SHARE URL -->
        <fieldset class="mt2">
            <legend class="pl2 pr2">Share URL</legend>
            <code><pre>TODO: URL to current browse session</pre></code>
        </fieldset>

        <!-- Fullscreen view URL -->
        <fieldset class="mt2">
            <legend class="pl2 pr2">Full Screen URL</legend>
            <code><pre>TODO: URL to fullscreen view URL</pre></code>
        </fieldset>
