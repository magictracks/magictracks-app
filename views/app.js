          ...
          <section class="w-20 flex flex-column h-auto ma0 bt bb bw2">
            ...
            <section>
              ...
              ${state.playlists.all.map(playlist => {
                return html`
                    <li class="f7 truncate" data-id="${playlist._id}" onclick=${switchSelected}>${playlist.title}</li>
                `
              })}
              </ul>
            </section>
                    ...
                    <section class="flex flex-row w-100 mt2 mb4 pb4">
                      ...
                      <div class="overflow-auto">
                        <table class="f6 w-100 mw8 center" cellspacing="0">
                          <thead>
                            <tr>
                              <th class="fw6 bb b--black-20 tl pb2 pr3 bg-white">Track</th>
                              <th class="fw6 bb b--black-20 tl pb2 pr3 bg-white">Title</th>
                              <th class="fw6 bb b--black-20 tl pb2 pr3 bg-white">Details</th>
                              <th class="fw6 bb b--black-20 tl pb2 pr3 bg-white">Edit</th>
                            </tr>
                          </thead>
                          <tbody class="lh-copy">
                            ${section.resources.map( (resource, idx) =>
                              html`
                              <tr>
                                <td class="pv2 pr3 bb b--black-20">${idx}</td>
                                <td class="pv2 pr3 bb b--black-20"><a href="${resource.url}">${resource.title}</a></td>
                                <td class="pv2 pr3 bb b--black-20">${resource.description || "dropdown to details"}</td>
                                <td class="pv2 pr3 bb b--black-20">⚙️</td>
                              </tr>
                              `
                              )}
                          </tbody>
